                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                              <center><h3 style="font-weight:bold; font-family: 'Goudy Bookletter 1911', serif">Upload a project</h3></center>
                                                <form method="post" enctype="multipart/form-data" style="margin-top:-20px;"  action="{{ url('store') }}">
                                                    ...
                                                    <input type="submit"  value="Upload!" style="background-color:purple; width:133px;">
                                                </form>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12" style="border:1px solid purple; border-radius:10px; background-color:purple"> 
                                             ...
                                             @foreach($filedata as $row)
                                                <?php     
                                                    $file = pathinfo($row->name)["filename"];
                                                ?> 
                                                <button class="btn btn-default"  style=" width:150px; border-radius:5px;  margin:10px 10px">
                                               ...
                                               <center><a style="text-decoration:none; color:gray; font-weight:bold; font-size:17px;" id="get" href="{{url('projects/displaycode/'.$row->name)}}">{{$file}}</a></center>
                                    ...
                                    <form id="add-user" action="{{ route('projects.adduser')}}" method="POST">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input  type="hidden" name="project_id" value="{{$project->id}}" class="form-control">
                                                ...
                                                <button class="btn btn-default" style=" color:black; width:80px;" type="submit">Add!</button>
