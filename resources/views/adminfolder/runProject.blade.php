       ...
       <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-10 col-sm-12 col-xs-12">
                  <center><h2 style="font-family: 'Goudy Bookletter 1911';">Admin Run User's Project Page</h2></center>
                ...
                <table border="1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><center>Registration Portal</center></td>
                            <td><center><button style="background-color:purple; color:white; width:120px; border-radius:10px; font-family: 'Goudy Bookletter 1911', serif; border:1px solid purple">Run</button></center></td>
                        </tr>

                         <tr>
                            <td><center>Anifowoshe Gbenga</center></td>
                            <td><center>anifowoshegbenga11@yahoo.com</center></td>
                            <td><center>GPA Calculator</center></td>
                            <td><center><button style="background-color:purple; color:white; width:120px; border-radius:10px; font-family: 'Goudy Bookletter 1911', serif; border:1px solid purple">Run</button></center></td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td><center>Reg Portal</center></td>
                            <td><center><button style="background-color:purple; color:white; width:120px; border-radius:10px; font-family: 'Goudy Bookletter 1911', serif; border:1px solid purple">Run</button></center></td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td><center>Data Collection and Display</center></td>
                            <td><center><button style="background-color:purple; color:white; width:120px; border-radius:10px; font-family: 'Goudy Bookletter 1911', serif; border:1px solid purple">Run</button></center></td>
                        </tr>
